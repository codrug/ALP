    ...
    return (
        <div className="pt-28 pb-24 px-6 max-w-7xl mx-auto animate-in fade-in">
            <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                <div>
                    <h1 className="text-5xl font-black tracking-tighter text-white mb-2">Curriculum Library
                    </h1>
            ...
            {filteredData.length === 0 && (
                <div className="py-32 text-center">
                    ...
                    <h3 className="text-2xl font-black text-gray-600 mb-2">No curriculum found
                    </h3>
                    <p className="text-gray-700 font-light">Adjust filters or upload new material.
                    </p>
                    {itemsError && (
